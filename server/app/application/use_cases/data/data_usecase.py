...
class GetDataUseCase(AbstractGetDataUseCase):
    def handle(self,url:str)->GetDataResponse:
        ...
        version         = bs.find("div",{"class":"mini-versions__LatestVersion-sc-19sko2j-5"})
        name            = bs.find("h1",{"class":"header-desktop__AppName-xc5gow-5"})
        ...
        description     = bs.find("h2",{"class":"header-desktop__AppNameH2-xc5gow-6"})
